...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/gen/genTemplate/form?id=${lnGenTemplate.id}">代码模板<shiro:hasPermission name="gen:genTemplate:edit">${not empty lnGenTemplate.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gen:genTemplate:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="lnGenTemplate" action="${ctx}/gen/genTemplate/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
