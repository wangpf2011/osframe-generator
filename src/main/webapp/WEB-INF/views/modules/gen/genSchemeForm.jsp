...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/gen/genScheme/form?id=${lnGenScheme.id}">生成方案<shiro:hasPermission name="gen:genScheme:edit">${not empty lnGenScheme.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gen:genScheme:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="lnGenScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
